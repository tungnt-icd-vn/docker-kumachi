...
<form method="post" id="wp_dummy_content_generatorGenPostForm" class="wp_dummy_content_generatorCol-9">
    ...
    <table class="form-table">
        ...
        <tr valign="top">
	        ...
	        <td>
	        	<input type="number" name="wp_dummy_content_generator-post_count" class="wp_dummy_content_generator-post_count"  placeholder="Number of posts" value="10" max="1500" min="1" />
